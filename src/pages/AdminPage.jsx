...
function AdminPage() {
  ...
  return <main className="admin-page" dir="rtl">
    <header className="admin-header"><div className="admin-logo"><span>SH</span><div><strong>مدينة السلطان هيثم</strong><small>لوحة الإدارة</small></div></div><button onClick={signOut}><LogOut size={17} /> تسجيل الخروج</button></header>
