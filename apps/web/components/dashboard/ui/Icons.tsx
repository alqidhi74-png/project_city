/**
 * Inline stroke icons — avoids an icon dependency and keeps every glyph on
 * `currentColor` so it inherits the surrounding text colour in both themes.
 */
...
export const CityLiveIcon = (p: IconProps) => (
  <Icon {...p}>
    <path d="M3 12h3l2.5-6 3.5 12 3-9 2 3h4" />
  </Icon>
);
...
export const PauseIcon = (p: IconProps) => (
  <Icon {...p}>
    <rect x="6.5" y="4.5" width="3.8" height="15" rx="1" fill="currentColor" stroke="none" />
    <rect x="13.7" y="4.5" width="3.8" height="15" rx="1" fill="currentColor" stroke="none" />
  </Icon>
);
...
/** Points along the reading direction — flip with `scale-x-[-1]` for RTL "back". */
...
export const SortIcon = (p: IconProps) => (
  <Icon {...p}>
    <path d="m7 9 3-3 3 3M7 15l3 3 3-3" />
  </Icon>
);
...
export const ThresholdIcon = (p: IconProps) => (
  <Icon {...p}>
...
export const CloudIcon = (p: IconProps) => (
  <Icon {...p}>
    <path d="M7 18a4.5 4.5 0 0 1-.6-8.96A5.5 5.5 0 0 1 17.4 11 4 4 0 0 1 17 19H7Z" />
  </Icon>
);
